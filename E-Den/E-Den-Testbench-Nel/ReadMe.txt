========================================================================
    KONSOLENANWENDUNG: E-Den-Testbench-Nel-Projektübersicht
========================================================================

Diese E-Den-Testbench-Nel-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die E-Den-Testbench-Nel-Anwendung besteht.


E-Den-Testbench-Nel.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen E-Den-Testbench-Nel.pch sowie eine vorkompilierte 
