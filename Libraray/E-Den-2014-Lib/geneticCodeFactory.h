...
namespace EDen {
	...
	protected:
		...
		static void addLeaf(GeneticClauseList* clauses, bool doubleleaf, float energyCost, float primaryResourceCost, float maxSize, Color color, std::string primaryResource, unsigned int primaryResourceStorageSize, float energyStorageSize, std::string secondaryResource = "", unsigned int secondaryResourceStorageSize = 10.0f);
