...
bin/E-Den-2014.debug: $(MAINOBJECTS)
		g++ $^ $(MAINDEPS) -g -o $@
...
clean:
		rm bin/E-Den-2014 bin/E-Den-2014.debug $(LIBDIR)/libeden.a $(LIBDIR)/libeden.so $(LIBOBJECTS) $(MAINOBJECTS)
