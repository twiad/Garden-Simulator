...
ifeq ($(config),release)
  ...
  LIBS      += -lunittest -lGWEN-Renderer-OpenGL_DebugFont -lgwen_static -lGL -lfreeimage
...
ifeq ($(config),debug)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -L../../../lib -L../../../lib/linux -L../../../lib/linux/gmake
  LIBS      += -lunittestd -lGWEND-Renderer-OpenGL_DebugFontd -lgwen_staticd -lGL -lfreeimage
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
