...
ifeq ($(config),release)
  ...
  LIBS      += -lunittest -lGWEN-Renderer-SFML -lgwen_static -lsfml-graphics -lsfml-window -lsfml-system -lGL
...
ifeq ($(config),debug)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -L../../../lib -L../../../lib/linux -L../../../lib/linux/gmake
  LIBS      += -lunittestd -lGWEND-Renderer-SFMLd -lgwen_staticd -lsfml-graphics -lsfml-window -lsfml-system -lGL
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
